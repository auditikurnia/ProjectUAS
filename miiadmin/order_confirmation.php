...
<head>
	...
	<meta name="author" content="Auditi & Aulia"/>
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand"><img src="../logo/distroauadmin.png" /></a>
			</div>
		...
		<aside id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Laporan <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child">
						<li><a href="order_report.php">Laporan Data Penjualan</a></li>
					</ul>
				</li>
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Grafik<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child">
						<li><a href="chart_order_byday.php">Penjualan per Hari</a></li>
						<li><a href="chart_order_bymonth.php">Penjualan per Bulan</a></li>
					</ul>
				</li>
			</ul>
		</aside>
								...
								<div class="table-responsive">
									<table class="timetable_sub">
										...
										<tr>
											...
											<td align="center"><?php echo 'Rp '.number_format($totals,0,".","."); ?></td>
										</tr>
									</table>
								</div>
								<div style="margin-top:3%;"><p>Terima kasih atas pembelian Anda di Distro-AU, kami senang bahwa Anda telah memilih berbelanja dengan Distro-AU dan kami berharap dapat melayani Anda kembali.</p></div>
							</div>
						</div>
				</div>
			</div>
	...
	<footer class="footer-bottom">
		<div class="footer-right">
			&copy; 2023 Distro-AU | Design by Auditi & Aulia
		</div>
		<div class="clearfix"></div>
	</footer>
